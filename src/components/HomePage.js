...
const HomePage = ({ navigate }) => {
  ...
  return (
    <div className="font-sans antialiased text-gray-900 flex flex-col min-h-screen">
      {/* Header - Reducido en altura y con logos más grandes */}
      <header className={`fixed w-full transition-all duration-300 z-50 ${scrolled ? 'bg-green-800 py-0 shadow-md' : 'bg-green-800 py-0'}`}>
       ...
       {/* Hero Section - Responsivo con comportamiento diferente en PC y móvil */}
        ...
        >
          ...
          >
            ...
            <Link 
              to="/atlas"
              className="bg-white/80 hover:bg-white text-green-800 font-medium py-3 px-6 rounded-lg
        ...
        {/* Sección CTA - Botón actualizado para ser más simple */}
